...
REM build time.
IF EXIST "Documentacion.msha" COPY /Y "Documentacion.msha" HelpContentSetup.msha
...
REM Install the new content.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale es-es /wait 0 /operation install /sourceUri "%CD%\Documentacion.msha"
