...
REM Help Viewer 1.0
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale es-es /uninstall /silent /vendor "Vendor Name" /productName "A Sandcastle Documented Class Library" /mediaBookList "A Sandcastle Documented Class Library"
...
REM Help Viewer 2.x
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale es-es /wait 0 /operation uninstall /vendor "Vendor Name" /productName "A Sandcastle Documented Class Library" /bookList "A Sandcastle Documented Class Library"
